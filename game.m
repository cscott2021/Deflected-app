//
//  game.m
//  Deflected/Users/calebscott/Desktop/Deflected/Deflected/Base.lproj/Main.storyboard
//
//  Created by Caleb Scott on 11/9/15.
...
-(void)CollisionScore{
    ...
    if (CGRectIntersectsRect(SideControl.frame, PlayerYleft.frame)) {
        ...
        if (PlayerYleft.center.y < 105) {
            PlayerYleft.center = CGPointMake(PlayerYleft.center.x, 105);
        }
    }
    
    else {
        Left.center = CGPointMake(PlayerYleft.center.x + 0, Left.center.y + 1);
        if (PlayerYleft.center.y > 310) {
            PlayerYleft.center = CGPointMake(PlayerYleft.center.x, 310);
        }
    }
    ...
    if (CGRectIntersectsRect(SideControl.frame, PlayerYright.frame)) {
        ...
        if (PlayerYright.center.y < 105) {
            PlayerYright.center = CGPointMake(PlayerYright.center.x, 105);
        }
    }
    
    else {
        Right.center = CGPointMake(PlayerYright.center.x + 0, Right.center.y + 1);
        if (PlayerYright.center.y > 310) {
            PlayerYright.center = CGPointMake(PlayerYright.center.x, 310);
        }
    }
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (PlayerXbottom.center.x > 323) {
        PlayerXbottom.center = CGPointMake(323, PlayerXbottom.center.y);
    }
    if (PlayerXbottom.center.x < 52) {
        PlayerXbottom.center = CGPointMake(52, PlayerXbottom.center.y);
    }
    if (PlayerXbottom.center.y > 57) {
        PlayerXbottom.center = CGPointMake(PlayerXbottom.center.x, 57);
    }
    if (PlayerXbottom.center.y < 57) {
        PlayerXbottom.center = CGPointMake(PlayerXbottom.center.x, 57);
    }
    if (PlayerXtop.center.x > 323) {
        PlayerXtop.center = CGPointMake(323, PlayerXtop.center.y);
    }
    if (PlayerXtop.center.x < 52) {
        PlayerXtop.center = CGPointMake(52, PlayerXtop.center.y);
    }
    if (PlayerXtop.center.y > 355) {
        PlayerXtop.center = CGPointMake(PlayerXtop.center.x, 355);
    }
    if (PlayerXtop.center.y < 355) {
        PlayerXtop.center = CGPointMake(PlayerXtop.center.x, 355);
    }
    if (PlayerYleft.center.x > 15) {
        PlayerYleft.center = CGPointMake(15, PlayerYleft.center.y);
    }
    if (PlayerYleft.center.x < 15) {
        PlayerYleft.center = CGPointMake(15, PlayerYleft.center.y);
    }
    ...
    if (PlayerYright.center.x > 360) {
        PlayerYright.center = CGPointMake(360, PlayerYright.center.y);
    }
    if (PlayerYright.center.x < 360) {
        PlayerYright.center = CGPointMake(360, PlayerYright.center.y);
    }
