...
-(void)CollisionScore{
    ...
    if (CGRectIntersectsRect(SideControl.frame, PlayerYleft.frame)) {
        ...
        Left.center = CGPointMake(PlayerYleft.center.x + 0, Left.center.y + 1);
        if (PlayerYleft.center.y > 340) {
            PlayerYleft.center = CGPointMake(PlayerYleft.center.x, 340);
        }
    }
    ...
    if (CGRectIntersectsRect(SideControl.frame, PlayerYright.frame)) {
        ...
        Right.center = CGPointMake(PlayerYright.center.x + 0, Right.center.y + 1);
        if (PlayerYright.center.y > 340) {
            PlayerYright.center = CGPointMake(PlayerYright.center.x, 340);
        }
    }
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (PlayerXbottom.center.x > 358) {
        PlayerXbottom.center = CGPointMake(358, PlayerXbottom.center.y);
    }
    if (PlayerXbottom.center.x < 45) {
        PlayerXbottom.center = CGPointMake(45, PlayerXbottom.center.y);
    }
    ...
    if (PlayerXtop.center.x > 358) {
        PlayerXtop.center = CGPointMake(358, PlayerXtop.center.y);
    }
    if (PlayerXtop.center.x < 45) {
        PlayerXtop.center = CGPointMake(45, PlayerXtop.center.y);
    }
    if (PlayerXtop.center.y > 385) {
        PlayerXtop.center = CGPointMake(PlayerXtop.center.x, 385);
    }
    if (PlayerXtop.center.y < 385) {
        PlayerXtop.center = CGPointMake(PlayerXtop.center.x, 385);
    }
    if (PlayerYleft.center.x > 8) {
        PlayerYleft.center = CGPointMake(8, PlayerYleft.center.y);
    }
    if (PlayerYleft.center.x < 8) {
        PlayerYleft.center = CGPointMake(8, PlayerYleft.center.y);
    }
    ...
    if (PlayerYright.center.x > 395) {
        PlayerYright.center = CGPointMake(395, PlayerYright.center.y);
    }
    if (PlayerYright.center.x < 395) {
        PlayerYright.center = CGPointMake(395, PlayerYright.center.y);
    }
